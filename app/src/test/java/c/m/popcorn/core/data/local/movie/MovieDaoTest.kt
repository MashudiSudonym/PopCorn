package c.m.popcorn.core.data.local.movie
...
class MovieDaoTest {
    ...
    private lateinit var db: PopCornLocalDatabase
    private lateinit var movieDao: MovieDao

    @Before
    fun createDb() {
        val context = ApplicationProvider.getApplicationContext<Context>()
        db = Room.inMemoryDatabaseBuilder(context, PopCornLocalDatabase::class.java)
